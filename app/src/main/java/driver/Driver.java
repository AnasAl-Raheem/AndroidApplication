...
public class Driver {
    ...
    public static String getClient(String email) {
        return Main.findUser(email).toString();
    }
    ...
    public static String getFlights(String date, String origin, String destination) {
        String str =  Main.displayFlights(Main.searchFlight(date, origin, destination));
        Main.cleanup();
        return str;
    }
    ...
    public static String getItineraries(String date, String origin, String destination) {
        String str = Main.displayItineraries(Main.searchItineraries(date, origin, destination));
        Main.cleanup();
        return str;
    }
    ...
    public static String getItinerariesSortedByCost(String date, String origin, String destination) {
        String str = Main.displayItineraries(Main.sortItineraries("Cost", Main.searchItineraries(date, origin, destination)));
        Main.cleanup();
        return str;
    }
    ...
    public static String getItinerariesSortedByTime(String date, String origin, String destination) {
    	String str = Main.displayItineraries(Main.sortItineraries("Time", Main.searchItineraries(date, origin, destination)));
        Main.cleanup();
        return str;
    }
}
